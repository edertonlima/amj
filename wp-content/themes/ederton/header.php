...
<body <?php body_class(); ?>>
	...
	*/ ?>
    ...
    <img src='<?php echo get_template_directory_uri(); ?>/assets/images/amj.png'
         srcset='<?php echo get_template_directory_uri(); ?>/assets/images/amj.png 2000w,
                 <?php echo get_template_directory_uri(); ?>/assets/images/amj.png 1000w'
